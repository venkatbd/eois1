...
toc_footers: 
   ...
   - <a href='https://github.com/joseph'>Documentation Powered by jay</a> 
...
## post /bem <img src="/images/posticon.png" alt="post" style="height: 10px; width:10px;"/>
...
## post /eois <img src="/images/posticon.png" alt="post" style="height: 10px; width:10px;"/>
...
## post /rsp <img src="/images/posticon.png" alt="post" style="height: 10px; width:10px;"/>
![#1589F0](https://via.placeholder.com/15/1589F0/1589F0.png) `# post /rsp/...`
...
endpoint is used for handling responses or sending data back to the client, as opposed to receiving requests. It might be used in situations where a client has made a request to an API, and the API's server responds with data or information. The response is typically sent back to the client through a designated API endpoint.
```shell
# You can also use wget
curl -X POST /rsp/..
  -H 'Content-Type: application/json' \
...
{
  "rsp:Transmission": {
    "@xmlns:rsp": "https://ldex.limra.com/xsd/1.0/LDExBEM",
    "@xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance",
    "@xsi:schemaLocation": "https://ldex.limra.com/xsd/1.0/LDExBEM_1.3.2022.01.01.xsd",
    "TransmissionGUID": "c9fcc147-2b65-48cb-925c-9f898a381815",
    "SenderName": "ABC Tech Partner",
